...
//
export const useNewCount = (initial_count, initial_min, initial_max, callback) => {
    // state
...
/* ---------------- COUNT ------------------ */
    ...
    //
    return (
        [count, countUp, countDown, beforeCountNum, countNum, countNumDone, changeMax, changeMin]
    );
}
