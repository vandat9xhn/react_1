...
//
GroupLeftJoinedItem.propTypes = {};

//
function GroupLeftJoinedItem({ item }) {
    //
    ...
    return (
        <Link
            className="display-flex align-items-center padding-8px brs-6px color-inherit hv-bg-fb"
            to={`/group/${id}`}
        >
            <img
...
export default GroupLeftJoinedItem;
