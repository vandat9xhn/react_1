...
//
import AddFriendSentItem from '../item/AddFriendSentItem';

//
AddFriendSent.propTypes = {};

//
function AddFriendSent() {
    //
    const { data_state, setDataState, getData_API } = useDataShowMore({
        initial_arr: [],
        handle_API_L: (c_count) => handle_API_AddFriend_L('sent', c_count),
    });
