...
function PLUsedTime({ buying_time, rating_time, used_time_str }) {
    //
    return (
        <div className="PLUsedTime pos-rel text-third">
            <div className="PLUsedTime_title cursor-pointer">
                Đã dùng khoảng {used_time_str}
            </div>

            <div className="PLUsedTime_contain display-none pos-abs bottom-100per font-12px">
                <div className="padding-y-20px padding-x-15px bg-ccc brs-4px">
                    ...
                    <div className="margin-bottom-10px text-align-center text-555">
                        <span> Đã dùng</span>{' '}
