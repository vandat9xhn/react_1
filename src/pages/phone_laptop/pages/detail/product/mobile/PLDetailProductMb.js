...
function PLDetailProductMb({
    ...
    //
    return (
        <div className="PLDetailProductMb">
            ...
            >
                ...
                <div className="margin-bottom-10px">
                    <PLDetailInstallment installment_arr={installment_arr} />
                </div>
            ...
            <div className="margin-bottom-15px">
                <PLDetailPost post={post} openDetailPost={openDetailPost} />
            </div>

            <div ref={ref_rating_elm}>
                <PLDetailRating
                    product_id={id}
                    product_name={name}
...
export default PLDetailProductMb;
