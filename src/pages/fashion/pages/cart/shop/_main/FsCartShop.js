...
function FsCartShop({
    ...
    //
    const shop_total_price = getFsFsCartShopTotalPrice(group_arr);
    ...
    return (
        <div
            className={`FsCartShop bg-primary pos-rel ${
        ...
        >
            ...
            <div>
                {group_arr.map((group_obj, group_ix) => (
                    <div
                        key={group_ix}
                        className={`FsCartShop_group_item ${
                            !group_obj.type
                                ? 'FsCartShop_group_item-item'
                                : 'FsCartShop_group_item-group brs-3px'
                        }`}
                    >
