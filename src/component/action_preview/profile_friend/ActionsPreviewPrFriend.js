...
//
ActionsPreviewPrFriend.propTypes = {};

//
function ActionsPreviewPrFriend({ mutual_friend_count, friend_arr }) {
    //
    return (
        <div className="ActionsPreviewPrFriend display-flex">
            <IconFriends
...
export default ActionsPreviewPrFriend;
