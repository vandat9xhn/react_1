...
export const default_share_post_arr = [
    {
        "id": 1,
        "user": {
            "id": 1,
...
export const default_history_post_arr = [
    {
        "id": 1,
        "vid_pics_create": [],
...
// 
export const default_cmt_post_arr = [
    {
        "id": 1,
        "user": {
            "id": 2,
...
export const default_like_cmt_post_arr = [
    {
        "id": 1,
        "user": {
            "id": 3,
...
export const default_history_cmt_post_arr = [
    {
        "id": 1,
        "content_obj": {
            "has_more_content": false,
...
// 
export const default_sub_post_arr = [
    {
        "id": 1,
        "user": {
            "id": 3,
...
export const default_like_sub_post_arr = [
    {
        "id": 1,
        "user": {
            "id": 2,
...
export const default_history_sub_post_arr = [
    {
        "id": 1,
        "content_obj": {
            "has_more_content": true,
...
export const more_content_post = " more content post more\ncontent post more content post more content post"
