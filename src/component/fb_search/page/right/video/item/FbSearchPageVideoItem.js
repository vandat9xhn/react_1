...
function FbSearchPageVideoItem({ video_obj }) {
    ...
    //
    return (
        <div className="FbSearchPageVideoItem pos-rel padding-16px brs-8px bg-primary">
            <Link
                className="display-block pos-abs-100 z-index-1 brs-8px cursor-pointer hv-bg-hv"
                to={`/watch?id=${id}`}
            ></Link>

            <div className="display-flex">
                <div className="pos-rel margin-right-12px">
                    <img
